...
Rails.application.config.sorcery.configure do |config|
  ...
  config.facebook.scope = "public_profile, user_hometown, user_location, user_relationships, user_religion_politics, user_birthday, email, offline_access, publish_actions, read_stream, user_friends"
