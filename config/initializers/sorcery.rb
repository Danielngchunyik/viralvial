...
Rails.application.config.sorcery.configure do |config|
  ...
  config.twitter.callback_url = "http://http://viralvial-staging.herokuapp.com//oauth/callback?provider=twitter"
  # config.twitter.user_info_mapping = {email: "screen_name"}
  
  config.facebook.key = ENV['FACEBOOK_KEY']
  config.facebook.secret = ENV['FACEBOOK_SECRET']
  config.facebook.callback_url = "http://http://viralvial-staging.herokuapp.com//oauth/callback?provider=facebook"
  ...
  # simply add yo`ur domain in your /etc/hosts file in front of 127.0.0.1
  #
  # config.liveid.key = ""
