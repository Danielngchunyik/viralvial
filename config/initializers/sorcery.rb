...
Rails.application.config.sorcery.configure do |config|
  ...
  config.facebook.user_info_mapping = {email: "email", name: "name", facebook_id: "id", birthday: "birthday", gender: "gender", religion: "religion", marital_status: "relationship_status"}
